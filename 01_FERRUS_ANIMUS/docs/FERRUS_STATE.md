...
# Derniere mise a jour : 2026-04-17 (PIPELINE COMPLET — main_ferrus.ipynb livree)
...
- PIPELINE livree : main_ferrus.ipynb — 9 cellules, orchestration complete INTEL→EXEC→OUTPUT→RAPPORT
